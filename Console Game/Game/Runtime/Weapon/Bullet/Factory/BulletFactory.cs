...
namespace ConsoleGame.Weapons
{
    public sealed class RaycastBulletFactory : IBulletFactory
    {
        ...
        public RaycastBulletFactory(IReadOnlyCollidersWorld<IHealth> collidersWorld, IMovementFactory movementFactory, IGameObjectsGroup gameLoop, LayerMask? layerMask)
        {
